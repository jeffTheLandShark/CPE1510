...
-- * date:	      MSOE Spring Semester 2024
...
begin 
  ...
  DATAS <=  '1' when ADDR < X"0000001F" and MEMRD = '0' and MEMWR = '1' else --LDR from SLIDERS
				'0' when ADDR = X"000000F4" and MEMRD = '0' and MEMWR = '1' else --LDR from MEM
				'1';
